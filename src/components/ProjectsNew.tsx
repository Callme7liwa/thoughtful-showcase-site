  ...
  const projects: Project[] = [
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/zinoo/zinoo_1.png`,
      images: Array.from({length: 6}, (_, i) => `${import.meta.env.BASE_URL}/images/zinoo/zinoo_${i + 1}.png`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/patrimoin/patri_1.png`,
      images: Array.from({length: 16}, (_, i) => `${import.meta.env.BASE_URL}/images/patrimoin/patri_${i + 1}.png`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/tasks/1.jpg`,
      images: Array.from({length: 6}, (_, i) => `${import.meta.env.BASE_URL}/images/tasks/${i + 1}.jpg`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/rap/rap_6.jpeg`,
      images: Array.from({length: 11}, (_, i) => `${import.meta.env.BASE_URL}/images/rap/rap_${i + 1}.jpeg`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/projects/project_1.png`,
      images: Array.from({length: 8}, (_, i) => `${import.meta.env.BASE_URL}/images/projects/project_${i + 1}.png`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/school/image_3.png`,
      images: Array.from({length: 8}, (_, i) => `${import.meta.env.BASE_URL}/images/school/image_${i + 1}.png`),
      githubUrl: "",
      liveUrl: "",
      category: "website",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/deliver/1.jpg`,
      images: Array.from({length: 10}, (_, i) => `${import.meta.env.BASE_URL}/images/deliver/${i + 1}.jpg`),
      githubUrl: "",
      appStoreUrl: "",
      playStoreUrl: "",
      category: "mobile",
...

    {
      ...
      image: `${import.meta.env.BASE_URL}/images/baby/baby_1.png`,
      images: Array.from({length: 6}, (_, i) => `${import.meta.env.BASE_URL}/images/baby/baby_${i + 1}.png`),
      githubUrl: "",
      category: "mobile",
      featured: false
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/foot/foot_1.jpeg`,
      images: Array.from({length: 2}, (_, i) => `${import.meta.env.BASE_URL}/images/foot/foot_${i + 1}.jpeg`),
      githubUrl: "",
      appStoreUrl: "",
      playStoreUrl: "",
      category: "mobile",
